...
var kDown		= (mouse_wheel_down() || keyboard_check_pressed( ord("S") )  );
var kUp			= (mouse_wheel_up() || keyboard_check_pressed( ord("W") ) );
...
if ( pause ){
	...
	for( var i = 0; i< bc; i++; ){
		...
		sca_set		= 1;		 // scale
		alpha_set	= 1;		// alpha
		col_set		= c_aqua; //color
		xoff_set	= 20;	  // offset to the right
...
#endregion
/*
var _movex=(keyboard_check(ord("G")) - keyboard_check(ord("J")))
var _movey=(keyboard_check(ord("Y")) - keyboard_check(ord("H")))

font_xtest+=_movex*10
font_ytest+=_movey*10
*/

	//show_debug_message("fontx: " + string(font_xtest))
	//show_debug_message("fonty: " + string(font_ytest))
