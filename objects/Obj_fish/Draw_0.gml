...
if instance_exists(Obj_player){
	...
	if global.size<_bal{
		...
		if !eatable{draw_sprite_ext(Spr_glow,0,x,y,size/1.5,size/1.5,0,image_blend,1);}
...
//aw_self();
draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,size,0,image_blend,1)
